...
BloomFilter::BloomFilter(unsigned int mer_counts, int k) {
    int filterSize = calculate_filter_size(mer_counts, k);
    int numHashFunctions = calculate_number_of_hash_functions(filterSize,mer_counts);
